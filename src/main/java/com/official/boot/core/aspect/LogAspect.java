package com.official.boot.core.aspect;
...
import com.official.boot.common.util.IPUtils;
import com.official.boot.security.util.SecurityUtils;
import com.official.boot.system.model.entity.Log;
import com.official.boot.system.service.LogService;
...
public class LogAspect {
     ...
     * 切点
     */
    @Pointcut("@annotation(com.official.boot.common.annotation.Log)")
    ...
    public Object doAround(ProceedingJoinPoint joinPoint, com.official.boot.common.annotation.Log logAnnotation) throws Throwable {
     ...
     * @param userId        用户ID
     */
    private void saveLog(final JoinPoint joinPoint, final Exception e, Object jsonResult, com.official.boot.common.annotation.Log logAnnotation, long executionTime, Long userId) {
