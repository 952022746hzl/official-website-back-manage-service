package com.official.boot.platform.file.service.impl;
...
import com.official.boot.platform.file.model.FileInfo;
import com.official.boot.platform.file.service.FileService;
import io.minio.*;
    ...
    public boolean deleteFile(String filePath) {
        ...
        try {
            ...
            if (StrUtil.isNotBlank(customDomain)) {
                // https://oss.official.tech/default/20221120/test.jpg → 20221120/websocket.jpg
